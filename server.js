...
const start = () => {
    inquirer
      .prompt({
        ...
        choices: ['View All Department','View All Roles','View All Employees', 'View All Employees By Department', 'View All Employees By Manager','Add a Department','Add a Department','Add an Role','Update Employee Role','EXIT'],
      })
      .then((answer) => {
